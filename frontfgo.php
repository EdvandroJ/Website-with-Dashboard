...
<?php
  ...
  $fate = mysqli_query($connection, "SELECT * FROM fate");
  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-8">
        ...
        <?php if(mysqli_num_rows($fate) > 0) {
        while ($row2 = mysqli_fetch_array($fate))
          { ?>
        <div class="media">
          <div class="media-body">
            <h4 class="mt-0 mb-1"><?php echo $row2["servantnama"] ?></h4>
            <h5><?php echo $row2["servantseri"] ?></h5>
            <p><?php echo $row2["servantket"] ?></p>
          </div>
        <img class="ml-3" style="width: 200px; height: 100%;" src="images/<?php echo $row2["servantfoto"] ?>" alt="Gambar Tidak Ada">
      </div>
    <?php } } ?>
