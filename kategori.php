...
<body>
	...
	if (isset($_POST['Simpan'])) {
		...
		mysqli_query($connection, "insert into kategori values ('$kodekategori', '$kategorinama', '$kategoriket', '$kategoriref')");
...
?>
		...
		<div class="col-sm-10">
			...
			<form method="POST">
				...
				<div class="form-group row">
	  			...
	  			<div class="form-group row">
	    			<label for="kateogriket" class="col-sm-2 col-form-label">Keterangan Kategori</label>
	    			<div class="col-sm-10">
	  			...
	  			<div class="form-group row">
	    			...
	    			<div class="col-sm-10">
	      			<input type="text" class="form-control" id="kategoriref" name="inputref" placeholder="referensi kategori">
	   				</div>
	  			</div>
	...
	<table class="table table-hover table-danger">
		...
		<tbody>
			<?php $query = mysqli_query($connection, "select * from kategori");
			$nomor = 1;
			...
			{ ?>
				<tr>
					...
					<td>
						<a href="kategoriubah.php?ubahkategori=<?php echo $row['kategoriID']?>" class="btn btn-success btn-sm" title="EDIT">
