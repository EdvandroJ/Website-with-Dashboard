...
<?php
  ...
  $tf = mysqli_query($connection, "SELECT * FROM transformer");
  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-8">
        ...
        <?php if(mysqli_num_rows($tf) > 0) {
        while ($row2 = mysqli_fetch_array($tf))
          { ?>
        <div class="media">
          <div class="media-body">
            <h4 class="mt-0 mb-1"><?php echo $row2["botnama"] ?></h4>
            <p><?php echo $row2["botket"] ?></p>
          </div>
        <img class="ml-3" style="width: 200px; height: 100%;" src="images/<?php echo $row2["botfoto"] ?>" alt="Gambar Tidak Ada">
      </div>
    <?php } } ?>
