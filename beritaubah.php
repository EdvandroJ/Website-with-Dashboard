...
<?php 
	...
	if (isset($_POST['Edit'])) {
		...
		mysqli_query($connection, "UPDATE berita set beritaID = '$beritakode',beritajudul = '$beritanama',beritainti = '$beritainti',penulis = '$penulis',penerbit = '$penerbit',tanggalterbit = '$tanggal', destinasiID = '$kodedestinasi'
		...
		<div class="col-sm-10">
			...
			<form method="POST">
				<div class="form-group row">
	    			...
	    			<div class="col-sm-10">
	      			<input type="text" class="form-control" id="kodeberita" name="inputkode" value="<?php echo $rowedit["beritaID"]?>" >
	    			</div>
				</div>
				...
				<div class="form-group row">
	    			...
	    			<div class="col-sm-10">
	      			<input type="text" class="form-control" id="namaberita" name="inputnama" value="<?php echo $rowedit["beritajudul"]?>">
	   				</div>
	  			</div>
	  			...
	  			<div class="form-group row">
	    			...
	    			<div class="col-sm-10">
	      			<input type="text" class="form-control" id="inti" name="inputinti" value="<?php echo $rowedit["beritainti"]?>">
	   				</div>
	  			</div>
	  			...
	  			<div class="form-group row">
	    			...
	    			<div class="col-sm-10">
	      			<input type="text" class="form-control" id="penulis" name="inputpenulis" value="<?php echo $rowedit["penulis"]?>">
	   				</div>
	  			</div>
	  			...
	  			<div class="form-group row">
	    			...
	    			<div class="col-sm-10">
	      			<input type="text" class="form-control" id="penerbit" name="inputpenerbit" value="<?php echo $rowedit["penerbit"]?>">
	   				</div>
	  			</div>
	  			...
	  			<div class="form-group row">
	    			...
	    			<div class="col-sm-10">
	      			<input type="text" id="tanggal" name="inputtanggal" value="<?php echo $rowedit["tanggalterbit"]?>">
	   				</div>
	  			</div>
	  			...
	  			<div class="form-group row">
	    			...
	    			<div class="col-sm-10">
	      			<select type="text" class="form-control" id="kodedestinasi" name="kodedestinasi" value="<?php echo $rowedit2["destinasiID"]?>">
		...
		<tbody>
			...
			{ ?>
				<tr>
					...
					<td>
						<a href="beritaubah.php?ubahfoto=<?php echo $row['beritaID']?>" class="btn btn-success btn-sm" title="EDIT">
