...
<?php 
	...
	if (isset($_POST['Simpan'])) {
		...
		mysqli_query($connection, "insert into area values ('$kodearea', '$areanama', '$wilayah', '$keterangan', '$kodekabupaten')");
			...
			<form method="POST">
				...
				<div class="form-group row">
	  			...
	  			<div class="form-group row">
	    			...
	    			<div class="col-sm-10">
	      			<input type="text" class="form-control" id="areaket" name="inputket" placeholder="keterangan area">
	   				</div>
	  			</div>
	  			...
	  			<div class="form-group row">
	    			...
	    			<div class="col-sm-10">
	      			<select type="text" class="form-control" id="kodekabupaten" name="kodekabupaten">
		...
		<tbody>
			...
			{ ?>
				<tr>
					...
					<td>
						<a href="ubaharea.php?ubaharea=<?php echo $row['areaID']?>" class="btn btn-success btn-sm" title="EDIT">
