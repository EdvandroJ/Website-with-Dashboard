...
<body>
	...
	if (isset($_POST['Edit'])) {
		...
		$photo = $_POST['file'];
			...
			mysqli_query($connection, "UPDATE kabupaten set kabupatenKODE = '$kodekabupaten', kabupatenNAMA = '$kabupatennama',kabupatenALAMAT = '$alamat',kabupatenKET = '$keterangan',KABUPATENFOTOICON = '$ketfoto',KABUPATENFOTOICONKET = '$photo'
			where kabupatenKODE = '$kodekabupaten'");
		header("location:kabupaten.PHP");
		}

	$kodekab = $_GET["ubahkabupaten"];
	$editkab = mysqli_query($connection, "select * from kabupaten
		where kabupatenKODE = '$kodekab'");
		...
		<div class="col-sm-10">
			...
			<form method="POST">
				<div class="form-group row">
	    			...
	    			<div class="col-sm-10">
	      			<input type="text" class="form-control" id="kodekabupaten" name="inputkode" value="<?php echo $rowedit["kabupatenKODE"]?>" maxlength="4" >
	    			</div>
				</div>
				...
				<div class="form-group row">
	  			...
	  			<div class="form-group row">
	    			...
	    			<div class="col-sm-10">
	      			<input type="text" class="form-control" id="alamat" name="inputalamat" value="<?php echo $rowedit["kabupatenALAMAT"]?>">
	   				</div>
	  			</div>
	  			...
	  			<div class="form-group row">
	    			...
	    			<div class="col-sm-10">
	      			<input type="text" class="form-control" id="ketkabupaten" name="inputket" value="<?php echo $rowedit["kabupatenKET"]?>">
	   				</div>
	  			</div>
	  			...
	  			<div class="form-group row">
	    			...
	    			<div class="col-sm-10">
	      			<input type="text" class="form-control" id="fotoicon" name="inputfotoic" value="<?php echo $rowedit["kabupatenFOTOICON"]?>">
	   				</div>
	  			</div>
	  			...
	  			<div class="form-group row">
	    			...
	    			<div class="col-sm-10">
	      			<input type="file" id="file" name="file" accept="image/jpeg, image/webp, image/png" onchange="loadFile(event)" value="<?php echo $rowedit["kabupatenFOTOICONKET"]?>">
