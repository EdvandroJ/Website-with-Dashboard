...
<?php 
	...
	if (isset($_POST['Simpan'])) {
		...
		mysqli_query($connection, "insert into hotel values ('$kodehotel', '$hotelnama', '$alamat', '$keterangan', '$photo', '$kodearea')");
			...
			<form method="POST">
				...
				<div class="form-group row">
	  			...
	  			<div class="form-group row">
	    			...
	    			<div class="col-sm-10">
	      			<input type="text" class="form-control" id="alamat" name="inputalamat" placeholder="alamat hotel">
	   				</div>
	  			</div>
