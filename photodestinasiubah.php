		...
		<form method="POST" enctype="multipart/form-data">
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					...
					<p class="help-block">Bagian ini untuk unggah file</p>
				</div>
			</div>
		...
		<tbody>
			...
			while ($row = mysqli_fetch_array($query))
				...
				<tr>
					...
					<td>
						<a href="photodestinasihapus.php?hapusfoto=<?php echo $row[
							"fotoID"] ?>" class="btn btn-danger btn-sm" title="Delete">
